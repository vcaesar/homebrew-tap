...
class Codg < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "2b2c0429744c3a1dc7ac0ed5401d63aa41376eb45e73abfb399d4c00222c9d61"
    end

     on_arm do
      url "https://github.com/vcaesar/codg/releases/download/v#{version}/codg_darwin_arm64.zip"
      sha256 "bf8a048e059e1a570b0a97660b8f512bb63483eaa07b6acc619a7a1594709189"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "aa923394f2c780eb1a8b0ba28789ad7aa45b4733ed1a3a0518fb843f3af28d8e"
    end

    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/vcaesar/codg/releases/download/v#{version}/codg_linux_arm64.zip"
        sha256 "2eac01c13668aa34b59a8dc626404d53425eb99c923e520ae3b27e2c8a609c2a"
      else
