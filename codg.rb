...
class Codg < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "e130e60e22fbfd149169710968e87273d41c93c76a98762dc961a5c279d01202"
    end

     on_arm do
      url "https://github.com/vcaesar/codg/releases/download/v#{version}/codg_darwin_arm64.zip"
      sha256 "21483c39c0c1e750121a58b1dcbaa85625f4d9efcc5b3134d114a5e6d80418d6"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "f3d0df51eb80c5e66c3242eb222d5174ae3756c0d133587923162a80d321146f"
    end

    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/vcaesar/codg/releases/download/v#{version}/codg_linux_arm64.zip"
        sha256 "15857756285879044ac38b96107a06cc4b8ddbfc1a779a19d0cdf3db7125f056"
      else
